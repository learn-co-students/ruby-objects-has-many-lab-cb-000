...
describe 'Artist' do
  ...
  describe '#add_song' do 
    it 'takes in an argument of a song and adds that song to the artist\'s 
        collection and tells the song that it belongs to that artist' do 
  ...
  describe '#add_song_by_name' do 
    it 'takes in an argument of a song name, creates a new song with it and
        associates the song and artist' do 
  ...
  describe '.song_count' do 
    it 'is a class method that returns the total number of songs associated
        to all existing artists' do
